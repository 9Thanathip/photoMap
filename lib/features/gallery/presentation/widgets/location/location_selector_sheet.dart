...
class _LocationSelectorSheetState
  ...
  String? _country; // null = country view, non-null = province view
  ...
  void _selectProvince(BuildContext context, String country, String province) {
    ...
    AppSnack.success(context, AppLocalizations.of(context).addedTo(province));
...
class _ProvincesGrid extends StatelessWidget {
  ...
  final ScrollController scrollController;
  final void Function(String province) onSelect;
...
class _AlbumPickerCard extends StatefulWidget {
  const _AlbumPickerCard({
    required this.cover,
    required this.title,
    required this.count,
    required this.onTap,
  ...
  @override
  State<_AlbumPickerCard> createState() => _AlbumPickerCardState();
}

class _AlbumPickerCardState extends State<_AlbumPickerCard>
